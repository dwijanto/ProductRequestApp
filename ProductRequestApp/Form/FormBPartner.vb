...
Public Class FormBPartner
    Private Shared myform As FormBPartner
    Dim myController As BPartnerController

    Public Shared Function getInstance()
        If myform Is Nothing Then
            myform = New FormBPartner
    ...
    Sub DoWork()
        myController = New BPartnerController
        Try
